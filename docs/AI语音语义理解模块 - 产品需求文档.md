...
#### 3.1.4. 实时联网搜索 (Web Search) **(v2.0 New)**
...
### 3.2. 管理后台 (Admin Dashboard) **(v2.0 New)**

#### 3.2.1. 聊天调试台 (Chat Debugger)
*   **界面风格**：Manus Style (深色、极简、胶囊标签)。
*   **会话隔离**：支持创建多个独立会话，互不干扰。
...
#### 3.2.3. 知识库管理 (Knowledge Base)
*   文件列表展示。
*   支持文件上传与自动索引状态查看。

#### 3.2.4. 指令管理 (Instruction Mgmt)
